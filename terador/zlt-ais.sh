#!/bin/sh
curl http://www.wilkenn.site/tirador/mod/ais.tgz -o /tmp/firmware.tgz
echo "Checking hash!"
...
cd etc_ro/web/img
rm logo_ais.png
wget http://www.wilkenn.site/tirador/logo_ais.png
cd
cd etc_ro/web/theme
rm main.ais.css
wget http://www.wilkenn.site/tirador/main.ais.css
at_cmd at+zreset
reboot
else
echo "Not same!"
